                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">MANAGE TEACHER</li>
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAddTeacher">
                                        <i class="metismenu-icon pe-7s-add-user">
                                        </i>Add Teacher
                                    </a>
                                </li>
                                <li>
                                    <a href="home.php?page=manage-teacher">
                           ...
                           <!-- add here -->
                           <li class="app-sidebar__heading">ENROLLMENT EXAMINEE</li>
                                <li>
                                    <a href="home.php?page=enroll">
                                        <i class="metismenu-icon pe-7s-users">
                                        </i>Enrolled Examinee
                                    </a>
                                </li>
                            ...
                            <!--end here  -->
                              <!-- add here -->
                           <li class="app-sidebar__heading">SUBMISSION LIST</li>
                                <li>
                                    <a href="home.php?page=submission.php">
                                        <i class="metismenu-icon pe-7s-users">
                                        </i>Answer Submission
                                    </a>
                                </li>
                            ...
                            <!--end here  -->
                                ...
                                <li>
                                    <a href="home.php?page=written-result">
                                        <i class="metismenu-icon pe-7s-cup">
                                        </i>Written Result Sheet
                                    </a>
                                </li>

                                 <li class="app-sidebar__heading">Messages</li>
                                <li>
                                    <a href="home.php?page=feedbacks">
                                        <i class="metismenu-icon pe-7s-chat">
                                        </i>All Messages
                                    </a>
                                    <a href="home.php?page=reply">
                                        <i class="metismenu-icon pe-7s-chat">
                                        </i>Reply Message
                                    </a>
                                </li>
